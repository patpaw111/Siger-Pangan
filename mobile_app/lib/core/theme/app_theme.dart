...
class AppTheme {
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        textTheme: GoogleFonts.poppinsTextTheme().copyWith(
          ...
          bodyMedium: GoogleFonts.poppins(
            fontSize: 13, fontWeight: FontWeight.normal, color: AppColors.textTertiary,
          ),
          labelLarge: GoogleFonts.poppins(
            fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.darkSurface,
          ),
        ),
        appBarTheme: AppBarTheme(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: const BorderSide(color: AppColors.darkSurfaceVariant, width: 1),
          ),
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
          ...
          hintStyle: GoogleFonts.poppins(color: AppColors.textTertiary, fontSize: 14),
          labelStyle: GoogleFonts.poppins(color: AppColors.textTertiary, fontSize: 14),
        ),
        bottomNavigationBarTheme: const BottomNavigationBarThemeData(
          backgroundColor: AppColors.darkSurface,
